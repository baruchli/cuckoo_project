...
# curl -X POST http://192.168.1.4:5000/users -H "Content-Type: application/json"
...
# curl -X GET http://192.168.1.4:5000/users/<user_id>
...
# curl -X PUT http://192.168.1.4:5000/users/<user_id> -H "Content-Type: application/json"
...
# curl -X DELETE http://192.168.1.4:5000/users/<user_id>
...
# curl -X GET http://192.168.1.4:5000/users
...
# curl -X POST http://192.168.1.4:5000/users/table
...
# curl -X DELETE http://192.168.1.4:5000/users/table
...
# curl -X GET http://192.168.1.4:5000/users/records
