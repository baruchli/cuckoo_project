...
# curl -X POST http://192.168.1.4:5000/devices -H "Content-Type: application/json"
...
# curl -X GET http://192.168.1.4:5000/devices/<device_id>
...
# curl -X PUT http://192.168.1.4:5000/devices/<device_id> -H "Content-Type: application/json"
...
# curl -X DELETE http://192.168.1.4:5000/devices/<device_id>
...
# curl -X POST http://192.168.1.4:5000/devices/table
...
# curl -X DELETE http://192.168.1.4:5000/devices/table
...
# curl -X GET http://192.168.1.4:5000/devices/records
