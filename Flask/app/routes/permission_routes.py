...
# curl -X POST http://192.168.1.4:5000/permissions -H "Content-Type: application/json"
...
# curl -X GET http://192.168.1.4:5000/permissions/user/<user_id>
...
# curl -X DELETE http://192.168.1.4:5000/permissions/<permission_id>
...
# curl -X PUT http://192.168.1.4:5000/permissions/<permission_id>
...
# curl -X POST http://192.168.1.4:5000/permissions/table
...
# curl -X DELETE http://192.168.1.4:5000/permissions/table
...
# curl -X GET http://192.168.1.4:5000/permissions/records
...
# curl -X GET http://192.168.1.4:5000/permissions/accessible-devices/<user_id>
