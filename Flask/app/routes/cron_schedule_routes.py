...
# curl -X POST http://192.168.1.4:5000/cron_schedules -H "Content-Type:
...
# curl -X GET http://192.168.1.4:5000/cron_schedules/<schedule_id>
...
# curl -X PUT http://192.168.1.4:5000/cron_schedules/<schedule_id>
...
# curl -X DELETE http://192.168.1.4:5000/cron_schedules/<schedule_id>
...
# curl -X GET http://192.168.1.4:5000/cron_schedules
...
# curl -X POST http://192.168.1.4:5000/cron_schedules/table
...
# curl -X DELETE http://192.168.1.4:5000/cron_schedules/table
...
# curl -X GET http://192.168.1.4:5000/cron_schedules/records
...
# curl -X GET http://192.168.1.4:5000/cron_schedules/user/<user_id>/device/<device_id>
...
# curl -X GET http://192.168.1.4:5000/cron_schedules/file/<schedule_id>
